...
namespace backend.Controllers.WorkoutPlanController
{
    [ApiController]
    ...
    public class WorkoutPlanController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<WorkoutPlanDto>> CreateWorkoutPlan(WorkoutPlanCreateDto workoutPlanDto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> UpdateWorkoutPlan(Guid id, WorkoutPlanUpdateDto workoutPlanDto)
        {
